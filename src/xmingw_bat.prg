...
Procedure ook_xmingw_bat()
   ...
   Endif
      ...
      FErase(HG_ROOT+'\Source\'+'ook_mingw_xhb.bat')
        ...
        If !Empty(Main.Text_1.value) .and. !Empty(Main.Text_2.value) .and. !Empty(Main.Text_3.value)
            hb_Memowrit ( HG_ROOT+'\Source\'+'ook_mingw_xhb.bat' , Out )
            If File(HG_ROOT+'\Source\'+'ook_mingw_xhb.bat')
               MsgInfo("File: "+HG_ROOT+'\Source\'+'ook_mingw_xhb.bat'+" Created","Success...")
            Endif
        Endif
Return
