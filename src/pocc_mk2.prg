...
Procedure ook_pocc_mk2()
   ...
   If     !File(HG_ROOT+'\Source\'+'oohg.hbp')
           hbp_oohg()
   ElseIf !File(HG_ROOT+'\Source\'+'miniprint.hbp')
           hbp_miniprint()
   ElseIf !File(HG_ROOT+'\Source\'+'hbprinter.hbp')
           hbp_hbprinter()
   ElseIf !File(HG_ROOT+'\Source\'+'bostaurus.hbp')
           hbp_bostaurus()
   Endif
   ...
   FErase(HG_ROOT+'\Source\'+NameMemo()+'.bat')
        ...
        Out := Out + 'set HG_POCC=' + HG_POCC  + cNewLi
        Out := Out + cNewLi
        ...
        Out := Out + 'IF EXIST "%HG_CCOMP%"\bin\povars32.bat CALL "%HG_CCOMP%"\bin\povars32.bat' + cNewLi
        Out := Out + cNewLi
