...
Procedure ook_bcc_bat()
   ...
   FErase(HG_ROOT+'\Source\'+'ook_bcc.bat')
        ...
        Out := Out + '   for %%a in ( %HG_FILES1_PRG% ) do if not errorlevel 1 %HG_BCC%\bin\bcc32 %HG_X_FLAGS% %%a.c >> resul.txt' + cNewLi
        Out := Out + '   if errorlevel 1 goto EXIT2' + cNewLi
        Out := Out + '   for %%a in ( %HG_FILES2_PRG% ) do if not errorlevel 1 %HG_BCC%\bin\bcc32 %HG_X_FLAGS% %%a.c >> resul.txt' + cNewLi
        Out := Out + '   if errorlevel 1 goto EXIT2' + cNewLi
        Out := Out + '   for %%a in ( %HG_FILES_C% )    do if not errorlevel 1 %HG_BCC%\bin\bcc32 %HG_X_FLAGS% %%a.c >> resul.txt' + cNewLi
        Out := Out + '   if errorlevel 1 goto EXIT2' + cNewLi
        Out := Out + '   if not exist winprint.c echo winprint.c is missing! >> resul.txt' + cNewLi
        Out := Out + '   if exist winprint.c  %HG_BCC%\bin\bcc32 %HG_X_FLAGS% winprint.c >> resul.txt' + cNewLi
        Out := Out + '   if errorlevel 1 goto EXIT2' + cNewLi
        Out := Out + '   if not exist miniprint.c echo miniprint.c is missing! >> resul.txt' + cNewLi
        Out := Out + '   if exist miniprint.c %HG_BCC%\bin\bcc32 %HG_X_FLAGS% miniprint.c >> resul.txt' + cNewLi
        Out := Out + '   if errorlevel 1 goto EXIT2' + cNewLi
        Out := Out + '   if not exist bostaurus.c echo bostaurus.c is missing! >> resul.txt' + cNewLi
        Out := Out + '   if exist bostaurus.c %HG_BCC%\bin\bcc32 %HG_X_FLAGS% bostaurus.c >> resul.txt' + cNewLi
        Out := Out + '   if errorlevel 1 goto EXIT2' + cNewLi
        Out := Out + '   echo. >> resul.txt' + cNewLi
        Out := Out + cNewLi
        ...
        Out := Out + '   for %%a in ( %HG_FILES1_PRG% ) do if not errorlevel 2 %HG_BCC%\bin\tlib %HG_ROOT%\%LIB_GUI%\oohg +%%a.obj /P128 >> resul.txt' + cNewLi
        Out := Out + '   if errorlevel 2 goto EXIT2' + cNewLi
        Out := Out + '   for %%a in ( %HG_FILES2_PRG% ) do if not errorlevel 2 %HG_BCC%\bin\tlib %HG_ROOT%\%LIB_GUI%\oohg +%%a.obj /P128 >> resul.txt' + cNewLi
        Out := Out + '   if errorlevel 2 goto EXIT2' + cNewLi
        Out := Out + '   for %%a in ( %HG_FILES_C% )    do if not errorlevel 2 %HG_BCC%\bin\tlib %HG_ROOT%\%LIB_GUI%\oohg +%%a.obj /P128 >> resul.txt' + cNewLi
        Out := Out + '   if errorlevel 2 goto EXIT2' + cNewLi
        Out := Out + '   if not exist winprint.obj echo winprint.obj is missing! >> resul.txt' + cNewLi
        Out := Out + '   if not exist winprint.obj goto EXIT2' + cNewLi
        Out := Out + '   if exist winprint.obj  %HG_BCC%\bin\tlib %HG_ROOT%\%LIB_GUI%\hbprinter +winprint.obj >> resul.txt' + cNewLi
        Out := Out + '   if errorlevel 2 goto EXIT2' + cNewLi
        Out := Out + '   if not exist miniprint.obj echo miniprint.obj is missing! >> resul.txt' + cNewLi
        Out := Out + '   if not exist miniprint.obj goto EXIT2' + cNewLi
        Out := Out + '   if exist miniprint.obj %HG_BCC%\bin\tlib %HG_ROOT%\%LIB_GUI%\miniprint +miniprint.obj >> resul.txt' + cNewLi
        Out := Out + '   if errorlevel 2 goto EXIT2' + cNewLi
        Out := Out + '   if not exist bostaurus.obj echo bostaurus.obj is missing! >> resul.txt' + cNewLi
        Out := Out + '   if not exist bostaurus.obj goto EXIT2' + cNewLi
        Out := Out + '   if exist bostaurus.obj %HG_BCC%\bin\tlib %HG_ROOT%\%LIB_GUI%\bostaurus +bostaurus.obj >> resul.txt' + cNewLi
        Out := Out + '   if errorlevel 2 goto EXIT2' + cNewLi
        ...
        Out := Out + cNewLi
        Out := Out + '   if not exist resul.txt goto END' + cNewLi
        ...
        If !Empty(Main.Text_1.value) .and. !Empty(Main.Text_2.value) .and. !Empty(Main.Text_3.value)
            hb_Memowrit ( HG_ROOT+'\Source\'+'ook_bcc.bat' , Out )
            If File(HG_ROOT+'\Source\'+'ook_bcc.bat')
               MsgInfo("File: "+HG_ROOT+'\Source\'+'ook_bcc.bat'+" Created","Success...")
            Endif
        Endif
