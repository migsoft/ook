...
Procedure ook_mingw_mk2()
   ...
   FErase(HG_ROOT+'\Source\'+'ook_mingw_mk2.bat')
   FErase(HG_ROOT+'\Source\'+'ook_mingw_mk2_x64.bat')
        ...
        If !Empty(Main.Text_1.value) .and. !Empty(Main.Text_2.value) .and. !Empty(Main.Text_3.value)
            If Main.Combo_Bits.value == 1
               hb_Memowrit ( HG_ROOT+'\Source\'+'ook_mingw_mk2.bat' , Out )
            ElseIf Main.Combo_Bits.value == 2
               hb_Memowrit ( HG_ROOT+'\Source\'+'ook_mingw_mk2_x64.bat' , Out )
            Endif
            If File(HG_ROOT+'\Source\'+'ook_mingw_mk2.bat')
               MsgInfo("File: "+HG_ROOT+'\Source\'+'ook_mingw_mk2.bat'+" Created","Success...")
            ElseIf File(HG_ROOT+'\Source\'+'ook_mingw_mk2_x64.bat')
               MsgInfo("File: "+HG_ROOT+'\Source\'+'ook_mingw_mk2_x64.bat'+" Created","Success...")
            Endif
        Endif
Return
