...
Procedure ook_msvc_mk2()
   ...
   FErase(HG_ROOT+'\Source\'+'ook_hbmk2_vc.bat')
        ...
        If !Empty(Main.Text_1.value) .and. !Empty(Main.Text_2.value) .and. !Empty(Main.Text_3.value)
            hb_Memowrit ( HG_ROOT+'\Source\'+'ook_hbmk2_vc.bat' , Out )
            If File(HG_ROOT+'\Source\'+'ook_hbmk2_vc.bat')
               MsgInfo("File: "+HG_ROOT+'\Source\'+'ook_hbmk2_vc.bat'+" Created","Success...")
            Endif
        Endif
Return
