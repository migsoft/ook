...
*---------------------------------------------------------------------*
    Local Out :=''
        ...
        Out := Out + '   if exist winprint.prg  %HG_HRB%\%BIN_HRB%\harbour winprint  %HG_X_FLAGS% %~3 >> hbprinter_build.log 2>&1' + cNewLi
        ...
        Out := Out + '   if exist miniprint.prg  %HG_HRB%\%BIN_HRB%\harbour miniprint  %HG_X_FLAGS% %~3 >> miniprint_build.log 2>&1' + cNewLi
        Out := Out + '   if errorlevel 1 goto ERROR' + cNewLi
        ...
        Out := Out + '   if exist bostaurus.prg %HG_HRB%\%BIN_HRB%\harbour bostaurus %HG_X_FLAGS% %~3 >> bostaurus_build.log 2>&1' + cNewLi
        Out := Out + '   if errorlevel 1 goto ERROR' + cNewLi
